...
df_confirmed = pd.read_csv("https://raw.githubusercontent.com/veedora/covidbddata/main/time_series_covid19_confirmed_global.csv")
...
#Define Model 
model = Sequential()
model.add(LSTM(150, activation='selu', return_sequences=True, input_shape=(seq_size, n_features)))
...
next_pred_x = rescaled_prediction[14]
print('\nConfirmed cases tomorrow:', next_pred_x)
# print('Infected persons tomorrow:', )
# print('Recovered + Death persons tomorrow:',)